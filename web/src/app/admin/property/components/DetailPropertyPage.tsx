        ...
        <div className="lg:w-2/5 space-y-6">
          ...
          <div className="flex gap-3 pt-4">
            <Link href={`/admin/property/${property._id}/update-property`} className="flex-1">
              <button className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2">
                <Pencil size={20} />
                Edit Property
              </button>
            </Link>

            <DeleteDialog propertyId={property._id} />
          </div>
        </div>
      </div>
    </div>
